...
class Dictionary {
 ...
 public:
  ...
  friend bool containHelp(Dictionary::Node* A, keyType k);
  friend void trans(Dictionary* D, Dictionary::Node* U, Dictionary::Node* V);
  friend bool isParent(Dictionary::Node* A, Dictionary::Node* B);
};
